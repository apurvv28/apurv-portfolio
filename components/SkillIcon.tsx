...
export default function SkillIcon({ iconType, size = 32, className = "" }: SkillIconProps) {
  const iconMap: { [key: string]: JSX.Element } = {
    ...
    kubernetes: <SiKubernetes size={size} className={className} />,
    jenkins: <SiJenkins size={size} className={className} />,
    terraform: <SiTerraform size={size} className={className} />,
    ansible: <SiAnsible size={size} className={className} />,
    // Soft Skills
